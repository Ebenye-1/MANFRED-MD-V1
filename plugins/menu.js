...
*│◈ ʀᴀᴍ ᴜᴛɪʟɪsᴇʀ : ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB*
...
`);
                    ...
                    default:
                        ...
                        reply("MON PETIT TAPE BIEN LA COMMANDE NE FAIT PAS L'IDIOT🔴");
                }
        ...
        reply('MON PETIT CEST TUÉ LE RÉSEAU A NDEM.');
    }
});
