/**
Attention ne pas copier sous peine de ban
/**
...
const ownerNumber = ['237690022323']
...
console.log("CONNECTING MANFRED-MD-V1 🧬...");
...
let up = `*╭──────────────●●►*
> *➺ MANFRED-MD-V1🇨🇲 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ 𝐌𝐀𝐍𝐅𝐑𝐄𝐃 ✅*
...
if(senderNumber.includes("237690022323")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("Yo MANFRED-MD-V1 STARTED ✅");
});
